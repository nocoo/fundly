...
> 本文档给 Claude / Codex 等 AI 编程 agent 使用。人类开发者请优先看 [`README.md`](README.md)。

## 🎯 项目定位

Fundly 是**中国公募基金数据采集与量化选基工具**。
...
| 编号 | 文档 | 内容 |
|---|---|---|
| **01** | `01-ARCHITECTURE.md` | 架构分层、数据流、反爬策略、测试策略 |
...
**新增文档规则**：
- 数字**顺延**（下一份文档用 `06-`）
- 文件名**大写字母 + 短横线**（`06-BACKTEST-ENGINE.md`）
